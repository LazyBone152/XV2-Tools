...
namespace VGAudio.Codecs.CriHca
{
    public static partial class CriHcaEncryption
    {
         ...
         */
        private static readonly List<ulong> KeyCodes = new List<ulong>()
        {
            1224,
            2424,
            8910,
            ...
            //Encrpytion Keys from VGMStream (https://github.com/vgmstream/vgmstream/blob/master/src/meta/hca_keys.h):
