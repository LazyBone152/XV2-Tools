...
namespace VGAudio.Containers.Hca
{
    public class HcaReader : AudioReader<HcaReader, HcaStructure, HcaConfiguration>
    {
        ...
        private static void ReadLoopChunk(BinaryReader reader, HcaStructure structure)
        {
            ...
            //This was in the original NAudio source code for some reason, but it caused looped tracks to get cut of at their LoopEnd points instead of playing their full duration
            //The sample count should never be set the loop end anyway... that doesn't make any sense at all
