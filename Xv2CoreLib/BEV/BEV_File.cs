...
namespace Xv2CoreLib.BEV
{
    ...
    public class Entry : IInstallable
    {
        ...
        [YAXDontSerializeIfNull]
        [YAXCollection(YAXCollectionSerializationTypes.RecursiveWithNoContainingElement, EachElementName = "BEV_Type9")]
        public List<Type_9> Type9 { get; set; }
    }
    ...
    [YAXSerializeAs("BEV_Type9")]
    public class Type_9 : TypeDef
    {
        [YAXAttributeForClass]
        [YAXSerializeAs("StartTime")]
        public ushort I_00 { get; set; }
