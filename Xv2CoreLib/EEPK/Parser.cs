        ...
        private void ParseEffects()
        {
            ...
            for (int i = 0; i < effectIds.Count(); i++)
            {
                ...
                for (int a = 0; a < effectSize[i]; a++)
                {
                    ...
                    eepkFile.Effects[i].EffectParts[a].AvoidSphere = BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 24);
                    eepkFile.Effects[i].EffectParts[a].StartTime = BitConverter.ToUInt16(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 28);
                    eepkFile.Effects[i].EffectParts[a].EMA_AnimationIndex = BitConverter.ToUInt16(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 30);
                    eepkFile.Effects[i].EffectParts[a].PositionUpdate = composite_I_32[0];
                    eepkFile.Effects[i].EffectParts[a].RotateUpdate = composite_I_32[1];
                    eepkFile.Effects[i].EffectParts[a].InstantUpdate = composite_I_32[2];
                    ...
                    eepkFile.Effects[i].EffectParts[a].I_38_a = Int4Converter.ToInt4(rawBytes[effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 38])[0];
                    eepkFile.Effects[i].EffectParts[a].I_38_b = Int4Converter.ToInt4(rawBytes[effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 38])[1];
                    eepkFile.Effects[i].EffectParts[a].NoGlare = composite_I_39[0];
                    eepkFile.Effects[i].EffectParts[a].I_39_1 = composite_I_39[1];
                    eepkFile.Effects[i].EffectParts[a].InverseTransparentDrawOrder = composite_I_39[2];
                    eepkFile.Effects[i].EffectParts[a].RelativePositionZ_To_AbsolutePositionZ = composite_I_39[3];
                    eepkFile.Effects[i].EffectParts[a].ScaleZ_To_BonePositionZ = composite_I_39[4];
                    eepkFile.Effects[i].EffectParts[a].I_39_5 = composite_I_39[5];
                    eepkFile.Effects[i].EffectParts[a].I_39_6 = composite_I_39[6];
                    eepkFile.Effects[i].EffectParts[a].ObjectOrientation_To_XXXX = composite_I_39[7];
                    eepkFile.Effects[i].EffectParts[a].PositionX = BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 40);
                    eepkFile.Effects[i].EffectParts[a].PositionY = BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 44);
                    eepkFile.Effects[i].EffectParts[a].PositionZ = BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 48);

                    eepkFile.Effects[i].EffectParts[a].RotationX_Min = (float)MathHelpers.ConvertRadiansToDegrees(BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 52));
                    eepkFile.Effects[i].EffectParts[a].RotationX_Max = (float)MathHelpers.ConvertRadiansToDegrees(BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 56));
                    eepkFile.Effects[i].EffectParts[a].RotationY_Min = (float)MathHelpers.ConvertRadiansToDegrees(BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 60));
                    eepkFile.Effects[i].EffectParts[a].RotationY_Max = (float)MathHelpers.ConvertRadiansToDegrees(BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 64));
                    eepkFile.Effects[i].EffectParts[a].RotationZ_Min = (float)MathHelpers.ConvertRadiansToDegrees(BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 68));
                    eepkFile.Effects[i].EffectParts[a].RotationZ_Max = (float)MathHelpers.ConvertRadiansToDegrees(BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 72));

                    eepkFile.Effects[i].EffectParts[a].ScaleMin = BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 76);
                    eepkFile.Effects[i].EffectParts[a].ScaleMax = BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 80);
                    eepkFile.Effects[i].EffectParts[a].NearFadeDistance = BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 84);
                    eepkFile.Effects[i].EffectParts[a].FarFadeDistance = BitConverter.ToSingle(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 88);
                    eepkFile.Effects[i].EffectParts[a].EMA_LoopStartFrame = BitConverter.ToUInt16(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 92);
                    eepkFile.Effects[i].EffectParts[a].EMA_LoopEndFrame = BitConverter.ToUInt16(rawBytes, effectOffsets[i] + effectInfoOffsets[i] + addedOffset + 94);
