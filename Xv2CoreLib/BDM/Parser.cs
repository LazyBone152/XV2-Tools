    ...
    public class Parser
    {
                ...
                switch (type)
                {
                    case BDM_Type.XV2_0:
                        for (int i = 0; i < count; i++)
                        {
                            ...
                            {
                                ID = BitConverter.ToInt32(rawBytes, offset),
        ...
        List<Type0SubEntry> GetType0_Xv2(int offset, int index)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                type0[i].Index = i;
                type0[i].DamageType = (DamageType)BitConverter.ToUInt16(rawBytes, offset + 0);
                type0[i].I_02 = BitConverter.ToUInt16(rawBytes, offset + 2);
                type0[i].DamageAmount = BitConverter.ToUInt16(rawBytes, offset + 4);
                type0[i].I_06 = BitConverter.ToUInt16(rawBytes, offset + 6);
                type0[i].F_08 = BitConverter.ToSingle(rawBytes, offset + 8);
                type0[i].AcbType = (AcbType)BitConverter.ToUInt16(rawBytes, offset + 12);
                type0[i].CueId = BitConverter.ToInt16(rawBytes, offset + 14);
                type0[i].Effect1_ID = BitConverter.ToInt16(rawBytes, offset + 16);
                type0[i].Effect1_SkillID = BitConverter.ToUInt16(rawBytes, offset + 18);
                type0[i].Effect1_EepkType = (EepkType)BitConverter.ToUInt16(rawBytes, offset + 20);
                type0[i].I_22 = BitConverter.ToUInt16(rawBytes, offset + 22);
                type0[i].Effect2_ID = BitConverter.ToInt16(rawBytes, offset + 24);
                type0[i].Effect2_SkillID = BitConverter.ToUInt16(rawBytes, offset + 26);
                type0[i].Effect2_EepkType = (EepkType)BitConverter.ToUInt16(rawBytes, offset + 28);
                type0[i].I_30 = BitConverter.ToUInt16(rawBytes, offset + 30);
                type0[i].Effect3_ID = BitConverter.ToInt16(rawBytes, offset + 32);
                type0[i].Effect3_SkillID = BitConverter.ToUInt16(rawBytes, offset + 34);
                type0[i].Effect3_EepkType = (EepkType)BitConverter.ToUInt16(rawBytes, offset + 36);
                type0[i].I_38 = BitConverter.ToUInt16(rawBytes, offset + 38);
                type0[i].PushbackStrength = BitConverter.ToSingle(rawBytes, offset + 40);
                type0[i].PushbackAcceleration = BitConverter.ToSingle(rawBytes, offset + 44);
                type0[i].UserStun = BitConverter.ToUInt16(rawBytes, offset + 48);
                type0[i].VictimStun = BitConverter.ToUInt16(rawBytes, offset + 50);
                type0[i].KnockbackDuration = BitConverter.ToUInt16(rawBytes, offset + 52);
                type0[i].KnockbackRecoveryAfterImpactTime = BitConverter.ToUInt16(rawBytes, offset + 54);
                type0[i].KnockbackGroundImpactTime = BitConverter.ToUInt16(rawBytes, offset + 56);
                type0[i].I_58 = BitConverter.ToUInt16(rawBytes, offset + 58);
                type0[i].KnockbackStrengthX = BitConverter.ToSingle(rawBytes, offset + 60);
                type0[i].KnockbackStrengthY = BitConverter.ToSingle(rawBytes, offset + 64);
                type0[i].KnockbackStrengthZ = BitConverter.ToSingle(rawBytes, offset + 68);
                type0[i].KnockbackDragY = BitConverter.ToSingle(rawBytes, offset + 72);
                type0[i].I_76 = BitConverter.ToUInt16(rawBytes, offset + 76);
                type0[i].KnockbackGravityTime = BitConverter.ToUInt16(rawBytes, offset + 78);
                type0[i].VictimInvincibilityTime = BitConverter.ToInt16(rawBytes, offset + 80);
                ...
                type0[i].UserBpeID = BitConverter.ToInt16(rawBytes, offset + 108);
                type0[i].VictimBpeID = BitConverter.ToInt16(rawBytes, offset + 110);
                type0[i].StaminaBrokenOverrideBdmId = BitConverter.ToInt16(rawBytes, offset + 112);
                type0[i].ZVanishEnableTime = BitConverter.ToUInt16(rawBytes, offset + 114);
                type0[i].UserAnimationTIme = BitConverter.ToUInt16(rawBytes, offset + 116);
                type0[i].VictimAnimationTime = BitConverter.ToUInt16(rawBytes, offset + 118);
                type0[i].UserAnimationSpeed = BitConverter.ToSingle(rawBytes, offset + 120);
                type0[i].VictimAnimationSpeed = BitConverter.ToSingle(rawBytes, offset + 124);
        ...
        List<Type1SubEntry> GetType1_Xv2(int offset, int index)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                type[i].Index = i;
                type[i].I_00 = (DamageType)BitConverter.ToUInt16(rawBytes, offset + 0);
                ...
                type[i].I_78 = (AlimentFlags)BitConverter.ToInt16(rawBytes, offset + 78);
                type[i].I_86 = BitConverter.ToUInt16(rawBytes, offset + 86);
                type[i].I_92 = BitConverter.ToUInt16(rawBytes, offset + 92);
                type[i].I_94 = (SecondaryTypeFlags)BitConverter.ToUInt16(rawBytes, offset + 94);
