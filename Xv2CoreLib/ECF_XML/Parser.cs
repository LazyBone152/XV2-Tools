...
using YAXLib;
using static Xv2CoreLib.ECF_XML.ECF_Entry;
                    ...
                    if (Type0_Count > 0)
                    {
                        ...
                        for (int a = 0; a < Type0_Count; a++)
                        {
                            ...
                            ecfFile.Entries[i].Animations.Add(new Type0()
                            {
                                ...
                                Component = Type0.GetComponent((Type0.ParameterEnum)rawBytes[Type0_Offset + 0], Int4Converter.ToInt4(rawBytes[Type0_Offset + 1])[0]),
